...
public class UserController {
    ...
    public List<Ticket> getUserTickets(@PathVariable Long userId) throws NotFoundException{
        return userService.getUserTickets(userId);
    }

    public List<Ticket> getUserTicketsFallback(@PathVariable Long userId) throws NotFoundException{
        return new ArrayList<>(Integer.parseInt("Service not available"));
    }
}
