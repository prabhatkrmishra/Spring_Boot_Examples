...
public class TuneInApplication {
    ...
    public static void main(String[] args) {
        ...
        // Use AnnotationConfigApplicationContext instead of XML-based context
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(TuneInApplication.class);
